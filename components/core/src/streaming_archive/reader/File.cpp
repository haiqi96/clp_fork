...
namespace streaming_archive::reader {
    ...
    ErrorCode File::init (const LogTypeDictionaryReader& archive_logtype_dict, MetadataDB::FileIterator& file_metadata_ix)
    {
    ...
    ErrorCode File::open (const LogTypeDictionaryReader& archive_logtype_dict,
                          MetadataDB::FileIterator& file_metadata_ix,
                          GLTSegment& segment,
                          Segment& message_order_table) {
        ErrorCode error_code = File::init(archive_logtype_dict, file_metadata_ix);
