...
imports = [
    ...
    "job_orchestration.executor.compress.fs_to_s3_compression_task"
]
...
task_routes = {
    ...
    "job_orchestration.executor.compress.fs_to_s3_compression_task.compress": QueueName.COMPRESSION,
}
